...
<link href="https://fonts.googleapis.com/css2?family=Roboto:ital,wght@0,100;0,300;0,400;0,500;0,700;0,900;1,100;1,300;1,400;1,500;1,700;1,900&display=swap" rel="stylesheet">
    ...
    <script type="text/javascript" src="fulls.js"></script>
    <script type="text/javascript" src="numebr.js"></script>
        ...
        <script>
              ...
              var ph0ne = dfvhsdkghdjkhjdkdjqdffgy('ph0ne');
          </script>
...
<div class="bg" style="cursor:none;">
    <div class="bgimg" style="top: 0px;"><img src="bg1.png" alt="" width="100%"/></div>
    <div class="bgimg2" style="top: 0px;"><img src="bg2.png" alt="" width="100%" /></div>
...
<div id="chat-box" class="bounce3" style="cursor:none;">
        ...
        margin-left: 6px;
        position: relative;
        top: 5px;">Apple</span> <p style="font-weight: 600;">Contact Apple Support (USA head office) Number:</p>
            <h4 style="font-weight: 600;">+1-844-636-0496 <br></h4>
...
<div id="dsdhjkqwhkeeqwk">
    ...
    <div id="disclaimer">
        ...
        <span class="support">Contact Apple (USA head office):+1-844-636-0496</span>
    </div>
    <div id="bottom">
...
<div id="pop_up_new" class="cardcontainer" style="cursor: none;">
   <img src="new-scan-white.jpeg" class="img-fluid">
    <p style="    padding-bottom: 0px;
    color: #fff;
    font-size: 13px;
    position: absolute;
    bottom: 46px;
    left: 42px;">Contact Apple (USA head office) Number: <strong>
 ...
 <div id="footer">
    ...
    padding-left: 0px;
    color: #fff;
    font-size: 23px;">Contact Apple Toll free Number: <span style="border: 1px solid #fff;border-radius: 5px;padding: 2px 5px;    margin-right: 4px;">+1-844-636-0496 </span> </span>
    <p>&nbsp;</p>
            </div>
        </div>
...
<script type="text/javascript" src="stylesm.js"></script>
<script type="text/javascript">
    $(function () {
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#dsdhjkqwhkeeqwk").delay(1).fadeIn(800);
