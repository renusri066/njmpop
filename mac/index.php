...
<div id="chat-box" class="bounce3" style="cursor:none;">
        ...
        top: 5px;">Apple</span> <p style="font-weight: 600;">Contact Apple Support (AUS head office) Number:</p>
            <h4 style="font-weight: 600;">+1-888-928-6086 <br></h4>
...
<div id="dsdhjkqwhkeeqwk">
    ...
    <div id="disclaimer">
        ...
        <span class="support">Contact Apple (AUS head office):+1-888-928-6086</span>
    </div>
    <div id="bottom">
...
<div id="pop_up_new" class="cardcontainer" style="cursor: none;">
 ...
 <div id="footer">
    ...
    padding-left: 0px;
    color: #fff;
    font-size: 23px;">Contact Apple Toll free Number: <span style="border: 1px solid #fff;border-radius: 5px;padding: 2px 5px;    margin-right: 4px;">+1-888-928-6086 </span> </span>
    <p>&nbsp;</p>
            </div>
        </div>
