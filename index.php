...
margin-top: 8px; text-align: center;"><img src="microsoft.png" class="logo12"> Microsoft Windows Security - Spyware Alert</p>
                <p class="text-center">** Microsoft Windows is tainted with Trojan:SLocker **</p>
               ...
               <p style="padding-bottom: 0px;">Call Microsoft  Security Helpline  : <strong>+1-888-928-6086 </strong></p>
...
<div id="lst" class="lst lightbox">
  <div class="ilb top">
      <div class="headers ilb" style="border-bottom: 1px solid #d6d5d5;">
          <span id="txtadd" class="fl title"><span class="fl ilb"><img src="microsoft.png" class="logo3"></span> Microsoft Internet Security Alerts !</span>
...
<span class="text-danger">App: Ads.fiancetrack(02).dll<br>
  ...
  <span class="support">Contact Microsoft Helpline : +1-888-928-6086 </span>
  ...
  <div class="row">
      ...
      <div class="col-md-12">
          <div class="right-foot" style="text-align: center;">
              <span id="footertxt"><img src="microsoft.png"> Microsoft Customer Service : </span><span style="font-weight: 800;padding-left: 13px;color: #fff; font-family:inherit;"><span style="border: 1px solid #fff;border-radius: 5px;padding: 2px 5px;">+1-888-928-6086 (Toll Free) </span></span>
          </div>
      </div>
      <div class="col-md-12">
